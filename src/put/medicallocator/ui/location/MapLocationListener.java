...
public class MapLocationListener implements LocationListener {
    ...
    public MapLocationListener(MapView mapView, RouteHandler routeHandler, State state) {
    ...
    public void onLocationChanged(Location location) {
        ...
        final GeoPoint currentPoint = GeoUtils.convertToGeoPoint(location.getLatitude(),
